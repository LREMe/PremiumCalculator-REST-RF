...
namespace PremiumCalculator.Infraestructure.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 1, "21-45", "Qwerty", 0, "September", "A", 150.0, "NY" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 2, "46-65", "Qwerty", 0, "January", "B", 200.5, "NY" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 3, "18-65", "Qwerty", 0, "*", "A,C", 120.98999999999999, "NY" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 4, "18-65", "Qwerty", 0, "November", "A", 85.5, "AL" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 5, "18-65", "Qwerty", 0, "*", "C", 100.0, "AL" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 6, "65+", "Qwerty", 0, "December", "A", 175.19999999999999, "AK" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 7, "18-64", "Qwerty", 0, "December", "A", 125.16, "AK" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 8, "18-65", "Qwerty", 0, "*", "B", 100.8, "AK" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 9, "18-65", "Qwerty", 0, "*", "A,C", 90.0, "*" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 10, "21-45", "Asdf", 0, "October", "A", 150.0, "NY" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 11, "46-65", "Asdf", 0, "January", "B", 184.5, "NY" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 12, "18-65", "Asdf", 0, "*", "A", 129.94999999999999, "NY" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 13, "18-65", "Asdf", 0, "November", "A", 84.5, "AL" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 14, "18-65", "Asdf", 0, "*", "B", 100.0, "WY" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 15, "18-65", "Asdf", 0, "*", "B,C", 100.8, "AK" });

            migrationBuilder.InsertData(
                table: "PremiumRols",
                columns: new[] { "PremiumRolID", "Age", "Carrier", "Id", "MonthOfBirth", "Plan", "Premium", "State" },
                values: new object[] { 16, "18-65", "Asdf", 0, "*", "A,C", 89.989999999999995, "*" });
