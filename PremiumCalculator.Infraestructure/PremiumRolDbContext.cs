namespace PremiumCalculator.Infraestructure
{

    /// <summary>
    /// Create DB 
    /// 1. Go to the premiumcalculator.infraestructure folder
    /// 2. Execute the following sentences
    ///     dotnet add package Microsoft.EntityFrameworkCore.Design  /*Add the package requiered*/
    ///     dotnet ef --startup-project ../premiumCalculatorWebAPI/ migrations add InitialCreate               /*Create the migration base on the configuration: clases in c#*/
    ///     dotnet ef database update --startup-project ../premiumCalculatorWebAPI/      /*execute the procedure to create objects*/
    /// </summary>
    /// 
    public class PremiumRolDbContext : DbContext, IUnitOfWork
    {
        /// <summary>
